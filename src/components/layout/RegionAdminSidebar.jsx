...
import { REGION_ADMIN_NAV } from '../../config/navigation';
import { LogOut, ChevronDown, ChevronRight } from 'lucide-react';

const RegionAdminSidebar = ({ isCollapsed, isMobileOpen, setIsMobileOpen }) => {
...
export default RegionAdminSidebar;
