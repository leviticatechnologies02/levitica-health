...
const BranchAdmins = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      accessor: 'branchName',
      render: (admin) => (
        <div className="flex items-center gap-1.5 cursor-pointer hover:text-primary-600 group" onClick={() => navigate('/groupAdmin/branches')}>
        ...
        <div>
          ...
          {filterBranchId ? (
            <div className="flex items-center gap-2 mt-2">
              ...
              <button onClick={() => navigate('/groupAdmin/branch-admins')} className="text-xs text-slate-500 hover:text-slate-900 underline">Clear Filter</button>
            </div>
          ) : (
