...
const GROUP_REVENUE_DATA = [
  { month: 'Jan', CityCenter: 4000, NorthWing: 2400, SouthMedical: 2400 },
  { month: 'Feb', CityCenter: 3000, NorthWing: 1398, SouthMedical: 2210 },
  { month: 'Mar', CityCenter: 2000, NorthWing: 9800, SouthMedical: 2290 },
  { month: 'Apr', CityCenter: 2780, NorthWing: 3908, SouthMedical: 2000 },
  { month: 'May', CityCenter: 1890, NorthWing: 4800, SouthMedical: 2181 },
  { month: 'Jun', CityCenter: 2390, NorthWing: 3800, SouthMedical: 2500 },
  { month: 'Jul', CityCenter: 3490, NorthWing: 4300, SouthMedical: 2100 },
];

const Reports = () => {
  const handleExport = (format) => {
    alert(`Generating group ${format.toUpperCase()} report...`);
  };
  ...
  return (
    <div className="animate-in fade-in zoom-in-95 duration-500 pb-10 space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Group Analytics & Reports</h1>
          <p className="text-slate-500 text-sm mt-1">Deep dive into performance metrics across all branches in your group.</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Total Group Revenue" value="$4.2M" icon={DollarSign} colorTheme="green" />
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="p-5 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center">
          <div>
            <h2 className="text-base font-bold text-slate-800">Branch Revenue Comparison</h2>
            <p className="text-xs text-slate-500 mt-0.5">Monthly revenue breakdown by top branches</p>
          </div>
        ...
        <div className="p-6 h-[400px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={GROUP_REVENUE_DATA} margin={{ top: 20, right: 30, left: 0, bottom: 5 }}>
              ...
              <Bar dataKey="CityCenter" fill="#4f46e5" radius={[4, 4, 0, 0]} barSize={20} />
              <Bar dataKey="NorthWing" fill="#0ea5e9" radius={[4, 4, 0, 0]} barSize={20} />
              <Bar dataKey="SouthMedical" fill="#f97316" radius={[4, 4, 0, 0]} barSize={20} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
