...
const RegionsAdmins = () => {
  const adminsColumns = [
    ...
    { header: 'Assigned Region', accessor: 'region' },
  ...
  const adminsData = [
    { name: 'Alice Smith', email: 'alice.s@example.com', region: 'North Region', status: 'Active' },
    { name: 'Bob Jones', email: 'bob.j@example.com', region: 'South Region', status: 'Active' },
  ];
    ...
    <div className="animate-in fade-in zoom-in-95 duration-500 flex flex-col h-full min-h-[calc(100vh-8rem)]">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage administrators for your geographical regions.</p>
        </div>
