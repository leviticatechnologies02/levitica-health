...
import { User, Mail, Phone, Camera, Save, Briefcase, HeartPulse } from 'lucide-react';
  ...
  return (
    <div className="animate-in fade-in zoom-in-95 duration-500 pb-10 mx-auto">
      <div className="mb-6">
        ...
        <p className="text-slate-500 text-sm mt-1">Manage your personal information and nursing credentials.</p>
      </div>
            ...
            {({ isSubmitting }) => (
              <Form className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider mb-2 flex items-center gap-2">
                      <Briefcase className="w-4 h-4 text-primary-500" /> Professional Details
                    </h3>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-slate-700 mb-1">Assigned Ward (Read-Only)</label>
                    ...
                    <div className="p-4 bg-primary-50 border border-primary-100 rounded-lg mt-4">
                      <div className="flex items-start gap-3">
                        <HeartPulse className="w-5 h-5 text-primary-600 shrink-0 mt-0.5" />
                        <div>
                          <p className="text-sm font-bold text-primary-800">Clearance: Patient Care</p>
                          <p className="text-xs text-primary-600 mt-1">You have access to view patient records, record vitals, and log medication administration for your assigned ward.</p>
                        </div>
                      </div>
                    </div>
                  </div>
