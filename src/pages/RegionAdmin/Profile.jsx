  ...
  return (
    <div className="animate-in fade-in zoom-in-95 duration-500 pb-10 mx-auto">
      <div className="mb-6">
        ...
        <p className="text-slate-500 text-sm mt-1">Manage your personal information and region administrative credentials.</p>
      </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-primary-50 border border-primary-100 rounded-lg mt-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-sm font-bold text-primary-800">Security Clearance Level: Region-Wide</p>
                          <p className="text-xs text-primary-600 mt-1">You have full read/write access to all groups, branches, and patient data within your designated region.</p>
                        </div>
                      </div>
                    </div>
                  </div>
