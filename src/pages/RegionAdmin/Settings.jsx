...
const Settings = () => {
  return (
    <div className="animate-in fade-in zoom-in-95 duration-500 pb-10">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Regional Settings</h1>
        <p className="text-slate-500 text-sm mt-1">Configure global preferences and policies for your entire region.</p>
      </div>

      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <Formik
          initialValues={{
            regionName: 'North America Region (HQ)',
            regionCode: 'REG-NA-01',
            timezone: 'America/New_York',
            contactEmail: 'regional.support@levitica.com',
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <Field name="regionName" className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 text-sm" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-slate-700 mb-1">Region Code (Read-Only)</label>
                      <Field name="regionCode" disabled className="w-full px-3 py-2 bg-slate-100 text-slate-500 border border-slate-200 rounded-lg text-sm cursor-not-allowed" />
                    </div>
                  </div>
                </section>
                  ...
                  <div className="space-y-4">
                    <label className="flex items-start gap-3 cursor-pointer group">
                      ...
                      <div>
                        ...
                        <span className="block text-xs text-slate-500">Allow region-wide broadcast notifications to be sent to branch admins.</span>
                      </div>
                    </label>
                    <label className="flex items-start gap-3 cursor-pointer group">
                      ...
                      <div>
                        ...
                        <span className="block text-xs text-slate-500">Requires all sub-groups to undergo secondary verification for data exports.</span>
                      </div>
                    </label>
                  </div>
                </section>
